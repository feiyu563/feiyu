...
class Server(models.Model):
    ...
    #software
    software = models.ManyToManyField('Software', verbose_name=u'软件', blank=True)
    create_at = models.DateTimeField(blank=True, auto_now_add=True)
...
class Software(models.Model):
    ...
    types = models.SmallIntegerField(u'系统类型', choices=os_types_choice,help_text=u'eg. GNU/Linux')  
